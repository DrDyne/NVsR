...
function NVsRObject() {
	...
	const registerFont = function registerFont() {
		for( let i=0; i<arguments.length; ++i ) {
			arguments[i] = 'fonts/' + arguments[i] + '.ttf';
		}
		return FontUtils.registerFontFamilyFromResources.apply( this, arguments );
	};
	
	this.titleFamily = registerFont( 'windlass-extended' );
	this.bodyFamily = registerFont( 'caxton-l-extended', 'caxton-li-extended' );
	this.abilityFamily = registerFont( 'caxton-b-extended' );
	...
	this.titleFont = new Font( this.abilityFamily, Font.BOLD, 10 );
...
Eons.namedObjects.NVsR = new NVsRObject();